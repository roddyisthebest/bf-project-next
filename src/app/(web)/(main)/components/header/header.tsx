...
import { ClosedCaption, Menu, X } from "lucide-react";
import {
  Dialog,
  DialogClose,
  DialogContent,
        ...
        <Dialog>
          ...
          <DialogContent className="h-full  p-0 min-w-full [&>button]:hidden rounded-none">
            <div className="flex flex-col ">
              <DialogTitle className="flex items-center justify-between h-20 px-4 border-b border-emerald-100 bg-gradient-to-b from-emerald-50/60 to-white backdrop-blur">
                <div className="flex items-center gap-2">
                  <span className="inline-flex h-9 w-9 items-center justify-center rounded-lg border border-emerald-200 bg-white text-lg font-bold leading-none">
                    B
                  </span>
