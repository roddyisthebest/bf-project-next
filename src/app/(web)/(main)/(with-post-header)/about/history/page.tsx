...
import { Calendar, MapPin, Users, Church } from "lucide-react";

const churchHistory = [
  {
    year: "2006",
    events: [
      { date: "4. 19", description: "큰숲교회 설립(안성시 원곡면 칠곡리 423-1)" },
  ...
  },
  {
    ...
    events: [
      ...
      { date: "9. 7", description: "지역복지과 연계 도시락반찬사역(11년마무리)" },
  ...
  },
  {
    ...
    events: [
      ...
      { date: "10.5-11.13", description: "40일 주님동행(성경읽기방)<동행과 성경>" }
    ]
  },
  {
    year: "2021",
  ...
  },
  {
    year: "2022",
    events: [
      { date: "5. 1", description: "주일 사랑방, 중고등부, 청년부 현장모임 재개" },
      { date: "7월", description: "청년부 캠프, 중고등부 GLB 재개" },
      { date: "10.17-11.4", description: "다니엘 특새<슬기로운 신앙생활-매일성경>" },
  ...
  },
  {
    ...
    events: [
      ...
      { date: "10.23-11.10", description: "다니엘 특새<주며들다-주님께로 스며들다>" }
    ]
  },
  {
    year: "2024",
    events: [
      ...
      { date: "10.14-11.1", description: "다니엘 특새<너희는 이렇게 기도하라>" },
...
const yearlyThemes = [
  { year: "2006-2007", theme: "정석교회 해법목회", subtitle: "교회 기초 세우기" },
  { year: "2008", theme: "열정", subtitle: "능력있는 삶 - 크게 생각하고 열정으로 살라" },
  { year: "2009", theme: "변화", subtitle: "성장과 성숙 - 닦고 조이고 기름치자" },
  { year: "2010", theme: "사랑", subtitle: "용서와 사랑 - 제가 먼저 사랑할래요" },
  { year: "2011", theme: "도전", subtitle: "새로운 도전 - 예수로 도전하고 생명으로 도약하라" },
  { year: "2012", theme: "건강", subtitle: "균형잡힌 삶 - 건강한 신앙으로 강건한 삶 UP" },
  { year: "2013", theme: "생기", subtitle: "활력있는 삶 - 생기! 살아내고 살려내고" },
  { year: "2014", theme: "먼저", subtitle: "삶의 우선순위 - 먼저 그의 나라와 그 의를 구하라" },
  { year: "2015", theme: "섬김", subtitle: "섬김의 삶 - 너희도 서로 발을 씻어주는 것이 옳으니라" },
  { year: "2016", theme: "설렘", subtitle: "초심으로 - 은혜의 설렘으로, 헌신의 초심으로" },
  { year: "2017", theme: "감사", subtitle: "감사의 삶 - 감사! 고백합니다. 예배합니다" },
  { year: "2018", theme: "존중", subtitle: "예배자 - 예배를 예배되게 교회를 교회되게" },
  { year: "2019", theme: "곁에", subtitle: "성도의 교제 - 당신 곁에, 주님 곁으로" },
  { year: "2020", theme: "더북", subtitle: "성경 - 성경 속에서 하나님을 만나다" },
  { year: "2021", theme: "격려", subtitle: "토닥토닥 - 서로 돌아보아 사랑과 선행을 격려하며" },
  { year: "2022", theme: "습관", subtitle: "좋은 습관으로 삶을 새롭게" },
  { year: "2023", theme: "드림", subtitle: "헌신 - 드림(헌신)이 드림(꿈)입니다" },
  { year: "2024", theme: "사귐", subtitle: "따름을 넘어 사귐으로, 눌림이 아닌 누림으로" },
  { year: "2025", theme: "기도", subtitle: "쉬지 말고 기도하라; 일상, 합심, 따로 기도" }
];
    ...
    <div className="max-w-6xl mx-auto p-6 space-y-12">
      ...
      <div className="text-center space-y-4">
        ...
        <p className="text-lg text-gray-600 max-w-2xl mx-auto">
          2006년 설립부터 현재까지, 하나님의 은혜 가운데 걸어온 큰숲교회의 역사입니다.
        </p>
      ...
      {/* 주요 이정표 */}
      <section>
        <h2 className="text-2xl font-bold text-center mb-8 text-emerald-800">주요 이정표</h2>
            ...
            return (
              <Card key={idx} className="text-center hover:shadow-lg transition-shadow">
                <CardContent className="p-6">
                  ...
                  <h3 className="font-bold text-lg mb-2 text-emerald-800">{milestone.title}</h3>
                  <p className="text-emerald-600 font-semibold mb-2">{milestone.year}</p>
      ...
      {/* 연도별 상세 연혁 */}
      <section>
        <h2 className="text-2xl font-bold text-center mb-8 text-emerald-800">연도별 상세 연혁</h2>
          ...
          <div className="space-y-8">
            {churchHistory.map((item, idx) => (
              <div key={idx} className="relative flex items-start gap-8">
                <div className="relative z-10 w-16 h-16 bg-gradient-to-r from-emerald-500 to-green-500 rounded-full flex items-center justify-center text-white font-bold shadow-lg">
                  {item.year.slice(-2)}
                </div>
                
                <Card className="flex-1 hover:shadow-lg transition-shadow">
                  <CardContent className="p-6">
                    <h3 className="text-xl font-bold text-emerald-800 mb-4">{item.year}년</h3>
                    <div className="space-y-3">
                      {item.events.map((event, eventIdx) => (
                        <div key={eventIdx} className="flex gap-4">
                          <span className="text-emerald-600 font-semibold min-w-fit">{event.date}</span>
      ...
      {/* 년도별 목양계획 */}
      <section>
        <h2 className="text-2xl font-bold text-center mb-8 text-emerald-800">큰숲 년도별 목양계획</h2>
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
          {yearlyThemes.map((theme, idx) => (
            <Card key={idx} className="hover:shadow-lg transition-shadow">
              <CardContent className="p-4">
                <div className="text-center">
                  <h3 className="font-bold text-emerald-800 mb-2">{theme.year}</h3>
                  <p className="text-lg font-semibold text-emerald-600 mb-2">{theme.theme}</p>
