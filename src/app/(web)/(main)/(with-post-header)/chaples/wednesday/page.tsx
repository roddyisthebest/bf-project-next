    ...
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      <div className="text-center mb-8">
        <p className="text-lg text-gray-600 max-w-2xl mx-auto">
          주 중에 하나님과 더 가까이 만나는 소중한 시간입니다. <br /> 말씀과
          기도로 영적 충전의 시간을 가져보세요.
        </p>
      </div>
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-gray-600">매주 수요일 오후 7:30</div>
                </div>
              </div>
              <div className="flex items-center gap-3">
            ...
            <div className="bg-gradient-to-br from-primary-50 to-brand-50 p-6 rounded-lg border border-primary-100">
              ...
              <div className="space-y-3">
                <p className="text-sm text-gray-700 leading-relaxed">
                  ...
                  말씀을 토대로 한 예배 말씀으로 진행됩니다. <br />
                  일상 속에서 실천할 수 있는 살아있는 하나님의 말씀을 나누는
                  시간입니다.
                </p>
                <div className="bg-white/50 p-3 rounded-lg border border-primary-200">
                  <p className="text-xs text-gray-600 leading-relaxed">
                    <strong className="text-primary">매일성경</strong>은
                    성서유니온에서 발행하는 매일 성경 묵상 교재로, <br /> 전
                    세계 수백만 명의 성도들이 동일한 말씀으로 묵상하는 전
                    세계적인 성경 묵상 운동입니다.
                  </p>
                </div>
              </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="text-gray-700 mb-2">
                수요예배는 현장 참석 중심의 예배로 진행되며, <br />
                별도의 온라인 영상은 제공하지 않습니다.
              </p>
